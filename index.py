...
from apps.records import clinicalname, labname, existingpatient, newpatient, viewclinicians, viewrecords, editrecords, addvaccine, editvaccine, adddeworm, editdeworm, editproblem, addproblemclinicalexam, editproblemclinicalexam, addproblemnote, editproblemnote, addproblemlabexam, editproblemlabexam, viewusers, generatereports, editusers, home_visit, purpose, managedata, help, vaccname, dewormname, newclinician, editclinicians, newuser
    ...
    if ctx.triggered:
        ...
        if eventid == "url":
            if userid < 0: # if logged out
                ...
                elif pathname == "/addvaccine":
                    returnlayout = addvaccine.layout
                elif pathname == "/editdeworm":
                    returnlayout = editdeworm.layout
                elif pathname == "/adddeworm":
                    returnlayout = adddeworm.layout
                ...
                elif pathname == "/addproblemclinicalexam":
                    returnlayout = addproblemclinicalexam.layout
                elif pathname == "/editproblemnote":
                    returnlayout = editproblemnote.layout
                elif pathname == "/addproblemnote":
                    returnlayout = addproblemnote.layout
                elif pathname == "/editproblemlabexam":
                    returnlayout = editproblemlabexam.layout
                elif pathname == "/addproblemlabexam":
                    returnlayout = addproblemlabexam.layout
