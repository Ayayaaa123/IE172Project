...
layout = html.Div(
    [
        ...
        html.H2('Create User Profile'),
        html.Hr(),
        dbc.Alert('Please supply necessary the details.', color="danger", id='signup_alert',
                  is_open=False),
        dbc.InputGroup(
            [dbc.InputGroupText("First Name"),  dbc.Input(id='vet_fn', type='text', placeholder="Enter First Name")],
            className = "mb-3",
            ),
        
        dbc.InputGroup(
            [dbc.InputGroupText("Last Name"),  dbc.Input(id='vet_ln', type='text',placeholder="Enter Last Name")],
            className = "mb-3",
            ),
        ...
        dbc.InputGroup(
            [dbc.InputGroupText("Contact Number"),  dbc.Input(id='vet_cn', type='text',placeholder="Enter Contact Number")],
            className = "mb-3",
            ),
        ...
        dbc.Modal(
            [
                ...
                dbc.ModalBody("Profile successfully created!", id='signup_confirmation'),
                dbc.ModalFooter(
                    dbc.Button(
                        "Okay", href='/'
                    )
...
@app.callback(
    ...
    [
        ...
        # Input('signup_modal', 'n_clicks') ### added
    ],
    [
        State('vet_fn', 'value'),
        State('vet_ln', 'value'),
